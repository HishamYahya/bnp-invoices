  ...
  return (
    ...
    >
      {service ? (
        ...
        <div>{`Create new service with name '${props.value}'`}</div>
      )}
    </MenuItem>
  );
}
...
function Placeholder(props) {
  ...
  return (
    <Typography {...props.innerProps}>
      Search a customer's phone number...
    </Typography>
  );
}
...
function SelectServiceField({
  ...
  function handleCreate() {
    createServiceAction(name, price, () => setCreating(false));
  }
      ...
      <NoSsr>
        ...
        <CreatableSelect
          ...
          onChange={value => {
            ...
            input.onChange(value);
            onSelect(value.reduce((acc, obj) => acc + obj.service.price));
          }}
        />
      </NoSsr>
    </div>
